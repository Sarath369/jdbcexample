...
import com.example.demo.component.SmsService;
...
public class SMSController {
    ...
    public void smsSubmit(@RequestBody final SmsPojo sms) {
        try {
            service.send(sms);
        } catch (Exception e) {
    ...
    public void smsCallback(@RequestBody final MultiValueMap<String, String> map) {
        service.receive(map);
